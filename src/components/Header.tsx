...
export function Header({
  ...
  const handleNavClick = (item: any) => {
    if (item.cat) {
      ...
      window.open(
        "https://www.instagram.com/sumanslucknowi/reels/",
        "_blank"
      );
    ...
    <header className="sticky top-0 z-40 w-full transition-all duration-300">
      ...
      <div className="bg-[#260808] text-[#F5EBE1] text-[10px] sm:text-[11px] tracking-[0.2em] uppercase font-sans py-2 px-4 md:px-8 border-b border-[#C9A86A]/25">
        <div className="max-w-[1440px] mx-auto flex justify-between items-center">
          ...
          <div className="hidden sm:flex items-center gap-2 text-[#DFCA9E]">
            ...
            <span>
              Ghatkopar East, Mumbai • Est. 1999
            </span>
          </div>

          <div className="flex-1 text-center font-medium">
            <span className="text-[#DFCA9E] font-semibold">
              2-Taar Handloom Chikankari
            </span>
      ...
      <div
        className={`
          ...
          duration-500
          ${isScrolled
            ? "shadow-[0_10px_35px_rgba(43,26,14,0.12)] py-2"
            : "py-3 md:py-4"
          }
        `}
      >
        ...
        {/* =================================================
            PURPLE 3D LUCKNOWI SAREE BACKGROUND
        ================================================== */}
        ...
        <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
          ...
          >
            <source
              src="/assets/purple-saree-3d-loop.mp4"
              type="video/mp4"
            />
          </video>
          ...
          <div
            className="
              absolute
              inset-0
              bg-[radial-gradient(ellipse_at_center,rgba(116,61,148,0.40),rgba(48,15,70,0.20)_55%,rgba(255,253,251,0.15))]
              mix-blend-multiply
            "
          />

          {/* SOFT WHITE CENTER FOR LOGO */}
          <div
            className="
              absolute
              inset-0
        ...
        <div className="relative z-10 max-w-[1440px] mx-auto px-4 md:px-8">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3 md:w-1/3">
              ...
              <div
                ref={searchRef}
                className="relative hidden md:block w-full max-w-[280px]"
              >
                ...
                <div className="flex items-center relative">
                  ...
                  <input
                    ...
                    className="
                      ...
                      border
                      border-white/60
                      shadow-[0_5px_20px_rgba(70,30,90,0.12)]
                      font-sans
                      text-[12px]
                      placeholder:text-[#6B4A7A]/70
                      focus:outline-none
                      focus:border-[#C9A86A]
                      focus:bg-white/85
                      transition-all
                        ...
                        {searchResults.map((prod) => (
                          ...
                          >
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="font-serif text-[13px] text-[#2B1A0E] truncate font-medium">
                                {prod.name}
                              </div>

                              <div className="font-sans text-[11px] text-[#8B7355]">
                                {prod.fabric} • Rs{" "}
              ...
              >
                ...
                <img
                  ...
                  className={`
                    ...
                    duration-500
                    filter
                    drop-shadow-[0_3px_8px_rgba(60,20,80,0.25)]
        ...
        ">
          ...
          ">
            ...
            ">
              ...
              <span>
                Shop No. 4, Neelkanth Sadan, Ghatkopar East, Mumbai
              </span>
            </div>
